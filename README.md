...
P.S. (9) It is theoretically (and practically) possible to develop a browser extension for autonomic automatic drawing. It will work like this: the extension makes a ChatGPT output hook and instead of a specific element, displays a Data URI image. To do this, you will need to slightly modify prompt 2 to coordinate the work of ChatGPT with the extension
...
P.S. (9) Теоретически (да и практически) можно разработать расширение для браузеров для автономного автоматического рисования. Работать будет так: расширение делает хук вывода ChatGPT и вместо определённо заданного элемента выводит Data URI изображение. Для этого нужно будет немного видоизменить промпт 2 для согласования работы ChatGPT с расширением
